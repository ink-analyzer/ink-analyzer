...
- Command and code action for extracting ink! events into standalone packages (only for [ink! v5](https://github.com/paritytech/ink/releases/tag/v5.0.0) projects).
