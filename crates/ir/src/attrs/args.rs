...
impl InkArgKind {
    ...
    pub fn detail(&self, version: Version) -> &str {
        match self {
            ...
            InkArgKind::Backend if version.is_v5() => "Tells the ink! e2e test runner which type of architecture to use to execute the test.",
            ...
            InkArgKind::Decode if version.is_v5() => "Derives an implementation of the `ink::scale::Decode` trait.",
            ...
            InkArgKind::Encode if version.is_v5() => "Derives an implementation of the `ink::scale::Encode` trait.",
            ...
            InkArgKind::Sandbox if version.is_v5() => "Tells the ink! e2e test runner which runtime emulator to use when executing the test.",
            ...
            InkArgKind::SignatureTopic if version.is_v5() => "Specifies custom signature topic of the event that allows to use manually specified shared event definition.",
            ...
            InkArgKind::TypeInfo if version.is_v5() => "Derives an implementation of the `ink::scale_info::TypeInfo` trait.",
