...
- [quickfixes][diagnostics] - suggested edits/code actions for fixing diagnostic errors and warnings.
...
- [hover content][hover] - popup documentation for ink! attribute macros and arguments.
